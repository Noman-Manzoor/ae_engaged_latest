...
const BoosterLesson5Topics = ({ navigation }) => {
    return (
        <View style={{ flex: 1, backgroundColor: '#90b1c2' }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', padding: 16, backgroundColor: '#90b1c2' }}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <Text style={{ fontSize: 9, backgroundColor: 'white', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 15, borderColor: '#ab713c', borderWidth: 1 }}>
                        Booster &gt; Booster Workbook &gt; Lesson 5
                    </Text>
                </View>
            </View>
            ...
            <View style={{ flex: 1, paddingTop: 25, alignItems: 'center' }}>
                <CustomButton
                    title="Principle"
                    onPress={() => navigation.navigate('Booster Lesson5 principle')}
                />
                <CustomButton
                    title="Couple Time "
                    onPress={() => navigation.navigate('Booster Lesson5 CP_Time')}
                />
                <CustomButton
                    title="Goals"
                    onPress={() => navigation.navigate('Booster Lesson5 Goals')}
                />
            </View>
        </View>
    );
...
export default BoosterLesson5Topics;
