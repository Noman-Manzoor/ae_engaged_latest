      ...
      <ScrollView>
        <View style={{ flex: 1 }}>
          ...
          source={require('../../../../../../assets/images/logo.png')}
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ fontSize: 12, backgroundColor: 'white', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 15, borderColor: '#ab713c', borderWidth: 1, textAlign: 'center' }}>
                workshop &gt; Lesson 2 &gt; Deep Listening
              </Text>
            </View>
          </View>
          ...
          <Image
            ...
            <Text>1. Turn on silent mode – your turn to listen</Text>
            ...
            <Text>• Could you repeat back what your partner just said?</Text>
            <Text>• Occasionally ask clarifying questions</Text>
            ...
            <Text>• Pause to allow your partner time to clarify, express support, etc.</Text>
