      ...
      <ScrollView >
        <View style={{ flex: 1 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', padding: 16, backgroundColor: '#90b1c2' }}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ fontSize: 12, backgroundColor: 'white', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 15, borderColor: '#ab713c', borderWidth: 1, textAlign: 'center' }}>
                workshop &gt; Lesson 3 &gt; Holland Quote
              </Text>
            </View>
          </View>
          ...
          <Image
            ...
            <Text style={{ fontSize: 16, marginLeft: 10, marginRight: 10, marginTop: 20 }}>
              “Of Souls, Symbols, and Sacraments”
            </Text>
            <Text style={{ fontSize: 16, marginLeft: 10, marginRight: 10, marginTop: 20, marginBottom:50 }}>
              “I submit to you that you will never be more like God at any other time in this life than when you are expressing that particular power (sexual intimacy). Such an act of love between a man and a woman is—or certainly was ordained to be—a symbol of total union: union of their hearts, their hopes, their lives, their love, their family, their future, their everything...such a total, virtually unbreakable union, such an unyielding commitment between a man and a woman, can only come with the proximity.”
            </Text>
          </ScrollView>
        </View>
      </ScrollView>
