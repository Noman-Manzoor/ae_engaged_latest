                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View >
                        <Image
                            ...
                            resizeMode='contain'
                        />
                        <Text style={{ fontSize: 16, marginBottom: 10, textAlign: 'center' }}>Lesson 4: Becoming One Through Equal Partnership & Complete Commitment
</Text>
                        ...
                        <Text style={{ fontSize: 16, paddingLeft: 25, paddingRight: 20 }}>What is a goal you can work on in making decisions
together this week?
{"\n"}
                        </Text>
