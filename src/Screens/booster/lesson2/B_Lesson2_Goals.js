...
const B_Lesson2_Goals = ({ navigation }) => {
    const screenName = "B_Lesson2_Goals";
    ...
    const handleBackPress = () => {
        ...
        navigation.navigate('Booster Lesson2 Topics');
    };
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', padding: 16, backgroundColor: '#90b1c2' }}>
                        ...
                        <View style={{ flex: 1 }}>
                            ...
                            <Text style={{ fontSize: 9, backgroundColor: 'white', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 15, borderColor: '#ab713c', borderWidth: 1, textAlign: 'left' }}>
                                Booster Workbook &gt; Lesson 2 &gt; Goals
                            </Text>
                        </View>
                    </View>
                    <View >
                        ...
                        <Text style={{ fontSize: 16, fontWeight: '900', paddingLeft: 25, marginBottom: 10 }}>This Week
                        </Text>
                        <Text style={{ fontSize: 16, paddingLeft: 25, paddingRight: 20 }}>List one thing you are going to do this week to
                            become beer communicators?{"\n"}
                        </Text>
...
export default B_Lesson2_Goals;
