...
const B_Lesson1_Goals = ({ navigation }) => {
    const screenName = "B_Lesson1_Goals";
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', padding: 16, backgroundColor: '#90b1c2' }}>
                        ...
                        <View style={{ flex: 1 }}>
                            ...
                            <Text style={{ fontSize: 9, backgroundColor: 'white', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 15, borderColor: '#ab713c', borderWidth: 1, textAlign: 'left' }}>
                                Booster Workbook &gt; Lesson 1 &gt; Goals
                            </Text>
                        </View>
                    </View>
                    <View >
                        ...
                        <Text style={{ fontSize: 16, fontWeight: '900', marginBottom: 10, paddingLeft: 20 }}>This Week
                        </Text>
...
export default B_Lesson1_Goals;
