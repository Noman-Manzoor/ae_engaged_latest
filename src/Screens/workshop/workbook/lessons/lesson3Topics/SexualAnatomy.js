...
const SexualAnatomy = ({ navigation }) => {
            ...
            <ScrollView >
                <View style={{ flex: 1 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', padding: 16, backgroundColor: '#90b1c2' }}>
                        ...
                        <View style={{ flex: 1 }}>
                            ...
                            <Text style={{ fontSize: 10, backgroundColor: 'white', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 15, borderColor: '#ab713c', borderWidth: 1, textAlign: 'left' }}>
                                Workbook &gt; Lesson 3 &gt; Sexual Anatomy
                            </Text>
                        </View>
                    </View>
                    ...
                    <ScrollView contentContainerStyle={{ paddingBottom: 16 }}>
                        ...
                        <Text style={{ fontSize: 14, marginBottom: 10, textAlign: 'center' }}>Lesson 3: Becoming One Through Marital Sexuality</Text>
                        <View style={{ width: '100%', borderBottomColor: '#ab713c', borderBottomWidth: 1, marginBottom: 10 }} />
                        <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 10, marginLeft: 10 }}>Sexual Anatomy Resources</Text>
